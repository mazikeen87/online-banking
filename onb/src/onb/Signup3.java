...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(long first)
    {
        ...
        t1.setText(String.valueOf(first));
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        first4=first4%Long.parseLong("10000");
        String b = "";
        if(c1.isSelected()){ 
            b = b+" ATM Card";
        }
        ...
        try{
            ...
            if(ae.getSource()==b1){
                ...
                if(b.equals("")){
                    ...
                    conn c1 = new conn();
                    first8=first8%Long.parseLong("10000000");
                    String q1 = "insert into signup3 values('"+first+"','"+a+"','"+first8+"','"+first4+"','"+b+"')";  
